...
async def generate_session_summary():
    ...
    try:
        ...
        if not status:
            return {"message": "No changes to summarize."}

        summary_lines = ["# Session Summary\n", f"Generated on: {os.uname().nodename} at typical session time\n", "## Changed Files\n"]
        ...
        return {"message": "Summary generated successfully.", "path": "SESSION_SUMMARY.md"}
